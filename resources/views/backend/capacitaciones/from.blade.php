    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="updateCapacitacionesForm" class="form" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <input type="hidden" name="id" value="{{$landingCapacitaciones->id}}">
                                <div class="mb-1">
                                    <label class="form-label" for="titulo">Titulo: </label>
                                    <input type="text" id="titulo" class="form-control"
                                           value="{{$landingCapacitaciones->titulo}}"
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="subtitulo" class="form-control"
                                           value="{{$landingCapacitaciones->subtitulo}}"
