                                    ...
                                    <div class="bs-stepper-content">
                                        ...
                                        <div id="informacion_basica" class="content dstepper-block active" role="tabpanel" aria-labelledby="tab_informacion_basica">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-6 col-sm-12">
                                                    ...
                                                    <input type="text" id="subtitulo_categoria" name="subtitulo_categoria" class="form-control" placeholder="john.doe@email.com">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                        ...
                                        <div id="informacion_adicional" class="content dstepper-block" role="tabpanel" aria-labelledby="tab_informacion_adicional">
                                            <div class="content-header">
                                                ...
                                                <small>Detakke y Seleccione todos los campos, esta información sera la primera que vea el usuario en la Web.</small>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" id="duracion" name="duracion" class="form-control" placeholder="40">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <p class="card-text">
                                                                Estimado usuario en esta sección solo se puede agregar 1 fotografia de max 5mb y un video de max 50mb.
                                                            </p>
