<div class="modal-size-lg d-inline-block">
    ...
    <!-- Modal -->
    <div class="modal fade text-start" id="categoria_modal" tabindex="-1" aria-labelledby="myModalLabel17" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form form-horizontal" id="categoriaForm">
