<x-admin-layout>
    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            ...
            @include('backend.ofertas.table_aplicaciones')
        </div>
    </div>

    @push('scripts')
        <script>
            var datatable = "{{ route('datatable_aplicaciones_ofertas') }}";
        </script>
        @include('layouts.back_front.scripts_datatable')
        <script src="{{ asset('app-assets/vendors/js/pickers/flatpickr/flatpickr.min.js') }}"></script>
        <script src="{{ asset('app-assets/pages/aplicacionesOfertas.js') }}"></script>
    @endpush
</x-admin-layout>
