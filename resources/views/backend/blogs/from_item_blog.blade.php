    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route($ruta) }}" method="POST" class="form" id="from_item_blog" enctype="multipart/form-data" onsubmit="return prepararContenidoQuill();">
                    ...
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="detalle">Fecha</label>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="detalle">Autor</label>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="detalle">Tipo de Blog</label>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="detalle">Resumen de 100 palabras</label>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="imagen">Imagen del Blog: </label>
